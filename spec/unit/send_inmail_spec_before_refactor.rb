...
RSpec.describe ScrapIn::SendInmail do
  ...
  describe '.execute' do
    ...
    context 'when we are unable to click on message button' do
      ...
      it 'raises a Capybara error' do
        expect { send_inmail_instance.execute }.to raise_error(Capybara::ElementNotFound)
      end
      it 'raises a Capybara error with the button text in the message' do
    ...
    context 'when we are unable to find the subject field' do
      ...
      it 'raises a Capybara' do
        expect { send_inmail_instance.execute }.to raise_error(Capybara::ElementNotFound)
      end
      it 'raises a Capybara error with the placeholder in the message' do
